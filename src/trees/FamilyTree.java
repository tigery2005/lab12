...
public class FamilyTree
{
	...
	private void addLine(String line) throws TreeException
	{
		...
		if (colonIndex < 0)
			throw new TreeException("Parent has no children");
		...
		else
		{
			...
			if (parentNode == null) {
				throw new TreeException("Data file has an issue");
			}
		}
	...
	TreeNode getMostRecentCommonAncestor(String name1, String name2) throws TreeException
	{
		...
		if (node1 == null)
			...
			throw new TreeException("Tree does not have a node with name " + name1);
		TreeNode node2 = root.getNodeWithName(name2);	// node whose name is name2
		if (node2 == null)
			throw new TreeException("Tree does not have a node with name " + name2);
